...
To run the example,  do the following:
 ...
 3. This project uses angular material package that is not included in the node_modules by default. You need to install it
    using the following command in the "client" directory:
