...
public class HelloWorldRestController {
	...
	@Autowired
	com.yxu.mvcangular.service.UserService userService; // Service which will do all data retrieval/manipulation work
	//
	// @GetMapping("/cool-cars")
	// @CrossOrigin(origins = "http://localhost:8080")
	// public Collection<Car> coolCars() {
	// return
	// repository.findAll().stream().filter(this::isCool).collect(Collectors.toList());
	// }
	...
	public ResponseEntity<List<User>> listAllUsers() {
		List<com.yxu.mvcangular.model.User> users = userService.findAllUsers();
		if (users.isEmpty()) {
